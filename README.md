...
```text
<!-- agent-notes:start -->
<!-- generated by agent-notes@0.2.1 -->
generated content
<!-- agent-notes:end -->
```
...
The current `0.2.1` release keeps the v0.2 detection scope and tightens
fresh-checkout test reliability, public library exports, package-manager
detection, and workspace matching correctness.
